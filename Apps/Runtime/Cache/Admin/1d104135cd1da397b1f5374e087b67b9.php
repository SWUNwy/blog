...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		...
		<a href="javascript:;" onclick="admin_permission_add('添加权限节点','ruleAdd.html','','600')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加权限节点</a></span> 
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<tr class="text-c">
				...
				<td>
				<a title="编辑" href="javascript:;" onclick="admin_permission_edit('角色编辑','ruleEdit.html','1','','310')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
