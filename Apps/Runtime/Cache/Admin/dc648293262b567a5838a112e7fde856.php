...
<div class="page-container">
	<div class="text-c">
		<input type="text" name="" id="" placeholder="会员名、id" style="width:250px" class="input-text">
		<button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜索</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> 
                <a href="javascript:;" onclick="member_add('添加用户','add-member.html','800','560')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> 
		...
		<tbody>
			<tr class="text-c">
				...
				<td class="td-manage">
                    ...
                    <a title="编辑" href="javascript:;" onclick="editMember('编辑','edit-member.html','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
<script type="text/javascript" src="/wp/Public/Admin/lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
<script type="text/javascript" src="/wp/Public/Admin/lib/laypage/1.2/laypage.js"></script>
...
/*用户-编辑*/
function editMember(title,url,id,w,h){
	layer_show(title,url,w,h);
}
/*密码-修改*/
