...
<body>
    ...
    <div class="page-container">
        <form action="<?php echo U('Blog/search');?>" method="post">
            <div class="text-c">
                <input type="text" name="" id="" placeholder="分类名称、id" style="width:250px" class="input-text">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a class="btn btn-primary radius" onclick="article_add('添加资讯', 'add_information.html')" href="javascript:;">
                ...
                <tbody>
                    <tr class="text-c">
                        ...
                        <td class="text-l"><u style="cursor:pointer" class="text-primary"
                                              onClick="article_edit('查看', 'article-zhang.html', '10001')" title="查看">资讯标题</u>
                        </td>
                        <td>行业动态</td>
                        <td>H-ui</td>
                        ...
                        <td class="f-14 td-manage">
                            ...
                            <a style="text-decoration:none" class="ml-5"
                               onClick="article_edit('资讯编辑', 'edit_information.html', '10001')" href="javascript:;"
